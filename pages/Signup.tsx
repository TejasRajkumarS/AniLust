...
const Signup: React.FC<SignupProps> = ({ onLogin }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      users.push(newUser);
      localStorage.setItem('anilust_users', JSON.stringify(users));
      localStorage.setItem('anilust_current_user', JSON.stringify(newUser));
    ...
    <div className="min-h-screen bg-background-dark flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-black text-white tracking-tight">Join Anilust</h1>
          <p className="text-slate-500 mt-2">Create your account to start watching</p>
        </div>
